...
Matrix::Matrix(double a1, double a2, double a3, double b1, double b2, double b3, double c1, double c2, double c3)
{
    data[0][0] = a1; data[0][1] = a2; data[0][2] = a3;
    data[1][0] = b1; data[1][1] = b2; data[1][2] = b3;
    data[2][0] = c1; data[2][1] = c2; data[2][2] = c3;
}
...
Matrix Matrix::operator* (const Matrix& gMatrix) const
{
    int i, j, k;
    Matrix tmp;
